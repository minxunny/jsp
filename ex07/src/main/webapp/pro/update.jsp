				...
				<form name="frm">
					...
					<div class="input-group mb-2">
						...
						<select class="form-select" name="dept">
							...
							<option value="전자" <c:out value="${pro.dept=='전자'?'selected':''}"/>>전기공학과</option>
					...
					<div class="input-group mb-2">
						...
						<div class="form-check m-2">
							<input value="정교수" name="title" class="form-check-input" type="radio" checked <c:out value="${pro.title=='정교수'?'checked':''}"/>>
							<label class="form-check-label">정교수</label>
						</div>
						<div class="form-check m-2">
							<input value="부교수" name="title" class="form-check-input" type="radio" <c:out value="${pro.title=='부교수'?'checked':''}"/>>
							<label class="form-check-label">부교수</label>
						</div>
						<div class="form-check m-2">
							<input value="조교수" name="title" class="form-check-input" type="radio" <c:out value="${pro.title=='조교수'?'checked':''}"/>>
